...
{
    [SerializeField] private AnimationCurve curveMovement; // 이동 제어 그래프
    [SerializeField] private AnimationCurve curveScale; // 크기 제어 그래프
    private BlockArrengeSystem blockArrangeSystem;
    ...
    public void Setup(BlockArrengeSystem blockArrangeSystem, Vector3 parentPosition)
    {
        ...
        // 우측 화면 바깥에 생성된 블록이 부모 오브젝트 위치(prent.position)까지 이동
